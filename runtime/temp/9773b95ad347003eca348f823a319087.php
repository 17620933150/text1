<?php /*a:1:{s:99:"D:\tool\PhpStudy20180211\PHPTutorial\WWW\tp5.1newshangcheng\application\admin\view\index\index.html";i:1534497892;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="JavaScript:;">后台首页</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li><?php echo session('role_name'); ?></li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<?php
		 ...
		 foreach($children[1] as $one): ?>
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> <?php echo $auths[$one]['auth_name']; ?><i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<?php foreach($children[ $one ] as $two): ?>
				<ul>
					<li><a data-href="<?php echo url('/admin/'.$auths[$two]['auth_c'].'/'.$auths[$two]['auth_a'].'/'); ?>" data-title="<?php echo $auths[$two]['auth_name']; ?>" href="javascript:void(0)"><?php echo $auths[$two]['auth_name']; ?></a></li>
				</ul>
				<?php endforeach; ?>
			</dd>
			<?php endforeach; ?>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="<?php echo config('admin_static'); ?>/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
