<?php /*a:1:{s:98:"D:\tool\PhpStudy20180211\PHPTutorial\WWW\tp5.1newshangcheng\application\admin\view\count\Text.html";i:1534737198;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
    ...
    $("#wechat").on('copy',function(){
        console.log('13246');
        $.ajax({
            url:"http://127.0.0.1:8000/admin/count/copyCount_add/"+os+"/"+ref+"/"+keyword,
